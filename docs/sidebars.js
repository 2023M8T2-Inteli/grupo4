...
const sidebars = {
  ...
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: ['Contexto da Indústria/1.1 Análise de Impacto Ético', 'Contexto da Indústria/1.2 TAM-SAM-SOM','Contexto da Indústria/1.3 Análise Financeira','Contexto da Indústria/1.4 Matriz de Riscos', 'Contexto da Indústria/1.5 Matriz de Oceano Azul'],
    },
    {
      type: 'category',
    ...
    },
    {
      ...
      items: ['Desenvolvimento da Solução/3.1 Design Patterns','Desenvolvimento da Solução/3.2 Mapeamento e navegação', 'Desenvolvimento da Solução/3.3 Chatbot', 'Desenvolvimento da Solução/3.4 Banco de Dados'],
    },
    {
      type: 'doc',
      label: 'Sprint Review',
