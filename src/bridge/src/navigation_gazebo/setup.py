...
setup(
    ...
    entry_points={
        'console_scripts': [
            "pose_queue=navigation_gazebo.pose_queue:main",
            "interface=navigation_gazebo.interface:main",
            "initial_pose=navigation_gazebo.initial_pose:main",
            "vallet=navigation_gazebo.vallet:main",
        ],
    },
)
